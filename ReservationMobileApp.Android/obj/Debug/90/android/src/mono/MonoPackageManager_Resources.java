...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ReservationMobileApp.Android.dll" comes first in this list. */
		"ReservationMobileApp.Android.dll",
		"DeviceDNA.Android.dll",
		"FFImageLoading.dll",
		...
		"JudoDotNetXamarinAndroidSDK.dll",
		"JudoPayDotNet.dll",
		"LiteDB.dll",
		"log4net.dll",
		"Newtonsoft.Json.dll",
